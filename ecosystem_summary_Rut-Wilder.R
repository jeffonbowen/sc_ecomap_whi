...
fname <- "dat/2025_May/MitigationProperty_ProjectFootprint_CEM_Intersect.xlsx"

# Use this if attribute file is xlsx.
eco_dat <- read_excel(fname) |> 
  filter(Location != "Marl Fen Property") |> 
...
write_csv(eu_summary, "out/2025_May/Rut_Wilder_2025_03_CEM_EU.csv")
...
write_csv(bhc_summary, "out/2025_May/Rut_Wilder_2025_03_BHC_Summary.csv")
